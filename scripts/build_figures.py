...
SCENES = {
    ...
    "1-5": (scene(bookshelf_ground_v2(58, 172, 1.0), dashed_arc(90, 118, 126, 118, lift=14), bot_v2(146, 172),
                  dashed_arc(166, 118, 206, 118, lift=14), person_v2(236, 172, face="smile"), check_pict_v2(262, 82, 0.6)),
            "たとえるなら", "たくさん読んで、教わって仕上がる", "読んで覚え、人に教わって整え、使われながら良くなる"),
    "1-6": (scene(person_v2(56, 172, face="smile"), bot_v2(150, 172), doc_pict_v2(104, 88, 0.62),
                  browser_pict_v2(150, 66, 0.62), chart_pict_v2(196, 88, 0.62), sparkle(234, 58)),
            "たとえるなら", "チャットに、道具が加わる", "ファイル・検索・データの分析・前提の保存を使い分ける"),
    "1-7": (scene(bot_v2(54, 172), browser_pict_v2(122, 86, 0.8), magnifier_v2(160, 120, s=1.0),
                  doc_pict_v2(212, 112, 0.72), person_v2(252, 172, face="smile")),
            "たとえるなら", "記憶より、情報源から", "新しい情報や正確な数字は、確かな資料や検索から始める"),
    "1-8": (scene(person_v2(50, 172, face="smile"), check_pict_v2(104, 88, 0.7), lock_pict_v2(150, 82, 0.72),
                  magnifier_v2(196, 96, s=0.9), bot_v2(248, 172)),
            "たとえるなら", "使う前の、3つの安全確認", "向いている作業か・入れてよい情報か・どこまで確かめるか"),
    # コース2: 営業週報
